...
// Raw HIP device management functions
C10_HIP_API hipError_t GetDeviceCount(int* dev_count);

C10_HIP_API hipError_t GetDevice(int* device);

C10_HIP_API hipError_t SetDevice(int device);

C10_HIP_API hipError_t MaybeSetDevice(int device);

C10_HIP_API int ExchangeDevice(int device);

C10_HIP_API int MaybeExchangeDevice(int device);

C10_HIP_API void SetTargetDevice();
...
C10_HIP_API bool hasPrimaryContext(DeviceIndex device_index);
C10_HIP_API c10::optional<DeviceIndex> getDeviceIndexWithPrimaryContext();
