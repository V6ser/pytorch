...
// HIP warp size is 32 for all existing GPU architectures, but there is no guarantee this will not change for future arch.
    ...
    if (softmax_elements == 0) {
        ...
        switch (log2_elements) {
            ...
            softmax_warp_forward<input_t, output_t, acc_t, L2E, is_log_softmax, is_masked>   \
                <<<blocks, threads, 0, at::hip::getCurrentHIPStream()>>>(dst,   \
       ...
       return;
        ...
        switch (log2_elements) {
            ...
            softmax_warp_backward<input_t, output_t, acc_t, L2E, is_log_softmax, is_masked> \
                <<<blocks, threads, 0, at::hip::getCurrentHIPStream()>>>       \
