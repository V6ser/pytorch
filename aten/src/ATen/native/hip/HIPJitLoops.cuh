...
// for passing the arguments to HIP Kernel
...
void jitted_gpu_kernel_generic(
  ...
  // These cases align with the non-jitted HIPLoops.cuh cases in gpu_kernel_impl
...
static void jitted_gpu_kernel_impl(
  ...
  static std::vector<JittedKernelVariantCache> device_caches(c10::hip::device_count());
