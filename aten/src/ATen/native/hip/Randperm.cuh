...
void randperm_handle_duplicate_keys(T *keys, scalar_t *data, int bits, int64_t n, c10::optional<at::Generator> &gen_) {
  auto gen = at::get_generator_or_default<at::HIPGeneratorImpl>(gen_, at::cuda::detail::getDefaultHIPGenerator());
  ...
  randperm_handle_duplicate_keys_kernel<<<(n + 511) / 512, 512, 0, at::hip::getCurrentHIPStream()>>>(
