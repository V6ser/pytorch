...
#if !(defined(USE_ROCM) || ((defined(__HIP_ARCH__) && (__HIP_ARCH__ < 800))))
#include <hip_bf16.h>
#endif
...
#if defined(USE_ROCM) || ((defined(__HIP_ARCH__) && (__HIP_ARCH__ < 700)))
...
#elif defined(USE_ROCM) || !(defined(__HIP_ARCH__))
...
// Dont use a templated function for this since the addition function defaults to the HIP built-in.
