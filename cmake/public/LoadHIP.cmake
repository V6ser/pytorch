...
if(NOT DEFINED {ROCM_PATH})
  set(ROCM_PATH C:/Progra~1/AMD/ROCm/5.7)
else()
  set(ROCM_PATH $ENV{ROCM_PATH})
endif()
if(NOT DEFINED {ROCM_INCLUDE_DIRS})
...
list(APPEND CMAKE_MODULE_PATH ${ROCM_PATH}/cmake ${ROCM_PATH}/lib/cmake/amdhip64 ${ROCM_PATH}/share ${ROCM_PATH}/lib/cmake/hip ${CMAKE_MODULE_PATH})
...
if(HIP_FOUND)
 ...
 # set(rccl_DIR ${ROCM_PATH}/lib/cmake/rccl) not available on Windows
  ...
  find_package_and_print_version(amdhip64 REQUIRED)
  include_directories(${AMDhip64_INCLUDE_DIR})
  ...
  # hipblast not available on Windows.
  if(ROCM_VERSION_DEV VERSION_GREATER_EQUAL "5.7.0" AND UNIX)
  ...
  find_package_and_print_version(rccl) # We don't set required here for Window.
